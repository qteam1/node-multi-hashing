...
NAN_MODULE_INIT(init) {
    ...
    Nan::Set(target, Nan::New("cryptonightfast").ToLocalChecked(), Nan::GetFunction(Nan::New<FunctionTemplate>(cryptonightfast)).ToLocalChecked());
